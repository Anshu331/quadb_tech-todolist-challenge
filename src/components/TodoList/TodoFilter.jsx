...
const TodoFilter = () => {
  ...
  return (
    <>
      <h1 className="hidden sm:block font-extrabold text-3xl text-center pb-7 pt-2 text-black drop-shadow-xl dark:text-custom-white">
        Filter
      </h1>
      <div className="font-bold text-black sm:space-y-3 text-lg flex flex-row justify-between sm:flex-col dark:text-custom-white">
        <div
          className={`cursor-pointer sm:hover:pl-2 hover:text-blue-900  duration-200 ${
            filterMode === "All" && "text-black dark:text-black"
          }`}
          onClick={() => dispatch(filter("All"))}
        >
          All
        ...
        <div
          className={`cursor-pointer sm:hover:pl-2 hover:text-blue-900 duration-200 ${
            filterMode === "Active" && "text-black dark:text-black"
          }`}
          onClick={() => dispatch(filter("Active"))}
        >
          Active
        ...
        <div
          className={`cursor-pointer sm:hover:pl-2 hover:text-blue-900 duration-200
          ${
            filterMode === "Completed" && "text-black dark:text-black"
          }`}
          onClick={() => dispatch(filter("Completed"))}
        >
          Completed
